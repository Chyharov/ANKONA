...
import s from './SectionEditGoods.module.scss';
...
const SectionEditGoods = ({ language }) => {
            ...
            currentProducts.map(product => {
              ...
              return (
                <li
                  ...
                  key={product.id}
                  onClick={() => navigate(`/editproductdetailspage/${product.id}`)}
                  style={{ cursor: 'pointer' }}
                >
                  <img
...
export default SectionEditGoods;
